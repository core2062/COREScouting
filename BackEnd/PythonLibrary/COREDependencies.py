...
def framework_begining():
      ...
      print('<nav>')
      print('<ul>')
      print('<li><a href="../index.html"><button>HOME</button></a></li>')
      print('<li><a href="CORETeamSelect.py"><button>SCOUT FORM</button></a></li>')
      print('<li><a href="COREMatchScheduleDisplay.py"><button>MATCH REPORT</button></a></li>')
      print('<li><a href="../GenerateRankingReport.html"><button>RANKING REQUEST</button></a></li>')
      print('<li><a href="CORETeamReportDisplay.py"><button>TEAM ANALYSIS</button></a></li>')
      print('</ul>')
      print('</nav>')
